...
@Component
public class DeleteScheduleTemplateRoute implements Routable {
    @Autowired
    ...
    public Function<PredicateSpec, Buildable<Route>> getRoute() {
        return predicateSpec -> predicateSpec.path(gatewayProperties.getDeleteScheduleTemplatePath())
                .and()
                .method(HttpMethod.DELETE)
                .filters(gatewayFilterSpec -> gatewayFilterSpec.stripPrefix(2)
                        .prefixPath(serviceProperties.getDeleteScheduleTemplatePath()))
