package com.studentscheduleapp.microservicesapi.imageservice.config;

import com.studentscheduleapp.microservicesapi.imageservice.http.HeaderRequestInterceptor;
