...
@Component
public class EditLessonTemplateRoute implements Routable {
    @Autowired
    ...
    public Function<PredicateSpec, Buildable<Route>> getRoute() {
        return predicateSpec -> predicateSpec.path(gatewayProperties.getEditLessonTemplatePath())
                .and()
                .method(HttpMethod.PATCH)
                .filters(gatewayFilterSpec -> gatewayFilterSpec.stripPrefix(2)
                        .prefixPath(serviceProperties.getEditLessonTemplatePath()))
