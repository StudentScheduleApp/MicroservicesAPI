package com.studentscheduleapp.microservicesapi.mailservice.config;

import com.studentscheduleapp.microservicesapi.mailservice.http.HeaderRequestInterceptor;
